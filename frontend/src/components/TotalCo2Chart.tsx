...
/**
 * Props for TotalCo2Chart component
 */
...
/**
 * Component for displaying total CO2 emissions based on provided data.
 * Supports different views: Tiers, Sectors, and Companies.
 */
export function TotalCo2Chart({
    ...
    /**
     * Transform company data using metaData.company_list for consistent order
     */
